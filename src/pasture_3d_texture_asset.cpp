...
bool Pasture3DTextureAsset::_is_valid_format(const Ref<Texture2D> &p_texture) const {
...
void Pasture3DTextureAsset::initialize() {
	LOG(INFO, _id, ": ", _name, ": initializing asset");
}

void Pasture3DTextureAsset::clear() {
...
void Pasture3DTextureAsset::set_name(const String &p_name) {
	if (p_name.length() > 96) {
...
void Pasture3DTextureAsset::set_id(const int p_new_id) {
	int old_id = _id;
	SET_IF_DIFF(_id, CLAMP(p_new_id, 0, Pasture3DAssets::MAX_TEXTURES - 1));
	LOG(INFO, "Setting texture id: ", _id);
	LOG(DEBUG, "Emitting id_changed, TYPE_TEXTURE, ", old_id, ", ", _id);
	emit_signal("id_changed", Pasture3DAssets::TYPE_TEXTURE, old_id, _id);
}

void Pasture3DTextureAsset::set_highlighted(const bool p_highlighted) {
...
void Pasture3DTextureAsset::set_albedo_color(const Color &p_color) {
...
void Pasture3DTextureAsset::set_albedo_texture(const Ref<Texture2D> &p_texture) {
...
void Pasture3DTextureAsset::set_normal_texture(const Ref<Texture2D> &p_texture) {
	if (_is_valid_format(p_texture)) {
...
void Pasture3DTextureAsset::set_normal_depth(const real_t p_normal_depth) {
...
void Pasture3DTextureAsset::set_roughness(const real_t p_roughness) {
...
void Pasture3DTextureAsset::set_ao_strength(const real_t p_ao_strength) {
...
void Pasture3DTextureAsset::set_ao_light_affect(const real_t p_ao_light_affect) {
...
void Pasture3DTextureAsset::set_displacement_scale(const real_t p_displacement_scale) {
...
void Pasture3DTextureAsset::set_displacement_offset(const real_t p_displacement_offset) {
...
void Pasture3DTextureAsset::set_uv_scale(const real_t p_scale) {
...
void Pasture3DTextureAsset::set_detiling_rotation(const real_t p_detiling_rotation) {
...
void Pasture3DTextureAsset::set_detiling_shift(const real_t p_detiling_shift) {
...
void Pasture3DTextureAsset::_bind_methods() {
	ADD_SIGNAL(MethodInfo("id_changed"));
	ADD_SIGNAL(MethodInfo("file_changed"));
	ADD_SIGNAL(MethodInfo("setting_changed"));

	ClassDB::bind_method(D_METHOD("clear"), &Pasture3DTextureAsset::clear);
	ClassDB::bind_method(D_METHOD("set_name", "name"), &Pasture3DTextureAsset::set_name);
	ClassDB::bind_method(D_METHOD("get_name"), &Pasture3DTextureAsset::get_name);
	ClassDB::bind_method(D_METHOD("set_id", "id"), &Pasture3DTextureAsset::set_id);
	ClassDB::bind_method(D_METHOD("get_id"), &Pasture3DTextureAsset::get_id);
	ClassDB::bind_method(D_METHOD("set_highlighted", "enabled"), &Pasture3DTextureAsset::set_highlighted);
	ClassDB::bind_method(D_METHOD("is_highlighted"), &Pasture3DTextureAsset::is_highlighted);
	ClassDB::bind_method(D_METHOD("get_highlight_color"), &Pasture3DTextureAsset::get_highlight_color);
	ClassDB::bind_method(D_METHOD("get_thumbnail"), &Pasture3DTextureAsset::get_thumbnail);
	ClassDB::bind_method(D_METHOD("set_albedo_color", "color"), &Pasture3DTextureAsset::set_albedo_color);
	ClassDB::bind_method(D_METHOD("get_albedo_color"), &Pasture3DTextureAsset::get_albedo_color);
	ClassDB::bind_method(D_METHOD("set_albedo_texture", "texture"), &Pasture3DTextureAsset::set_albedo_texture);
	ClassDB::bind_method(D_METHOD("get_albedo_texture"), &Pasture3DTextureAsset::get_albedo_texture);
	ClassDB::bind_method(D_METHOD("set_normal_texture", "texture"), &Pasture3DTextureAsset::set_normal_texture);
	ClassDB::bind_method(D_METHOD("get_normal_texture"), &Pasture3DTextureAsset::get_normal_texture);
	ClassDB::bind_method(D_METHOD("set_normal_depth", "normal_depth"), &Pasture3DTextureAsset::set_normal_depth);
	ClassDB::bind_method(D_METHOD("get_normal_depth"), &Pasture3DTextureAsset::get_normal_depth);
	ClassDB::bind_method(D_METHOD("set_ao_strength", "ao_strength"), &Pasture3DTextureAsset::set_ao_strength);
	ClassDB::bind_method(D_METHOD("get_ao_strength"), &Pasture3DTextureAsset::get_ao_strength);
	ClassDB::bind_method(D_METHOD("set_ao_light_affect", "ao_light_affect"), &Pasture3DTextureAsset::set_ao_light_affect);
	ClassDB::bind_method(D_METHOD("get_ao_light_affect"), &Pasture3DTextureAsset::get_ao_light_affect);
	ClassDB::bind_method(D_METHOD("set_roughness", "roughness"), &Pasture3DTextureAsset::set_roughness);
	ClassDB::bind_method(D_METHOD("get_roughness"), &Pasture3DTextureAsset::get_roughness);
	ClassDB::bind_method(D_METHOD("set_displacement_scale", "displacement_scale"), &Pasture3DTextureAsset::set_displacement_scale);
	ClassDB::bind_method(D_METHOD("get_displacement_scale"), &Pasture3DTextureAsset::get_displacement_scale);
	ClassDB::bind_method(D_METHOD("set_displacement_offset", "displacement_offset"), &Pasture3DTextureAsset::set_displacement_offset);
	ClassDB::bind_method(D_METHOD("get_displacement_offset"), &Pasture3DTextureAsset::get_displacement_offset);
	ClassDB::bind_method(D_METHOD("set_uv_scale", "scale"), &Pasture3DTextureAsset::set_uv_scale);
	ClassDB::bind_method(D_METHOD("get_uv_scale"), &Pasture3DTextureAsset::get_uv_scale);
	ClassDB::bind_method(D_METHOD("set_detiling_rotation", "detiling_rotation"), &Pasture3DTextureAsset::set_detiling_rotation);
	ClassDB::bind_method(D_METHOD("get_detiling_rotation"), &Pasture3DTextureAsset::get_detiling_rotation);
	ClassDB::bind_method(D_METHOD("set_detiling_shift", "detiling_shift"), &Pasture3DTextureAsset::set_detiling_shift);
	ClassDB::bind_method(D_METHOD("get_detiling_shift"), &Pasture3DTextureAsset::get_detiling_shift);
