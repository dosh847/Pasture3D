...
Dictionary Pasture3DUtil::dla_grow_field(const Dictionary &p_params) {
	...
	p.ridge_width = (double)p_params.get("ridge_width", 0.18);
...
PackedFloat32Array Pasture3DUtil::strata_grid(const PackedFloat32Array &p_surface, const int p_gw, const int p_gh,
	...
	return godot::strata_grid(p_surface, p_gw, p_gh, p_rect, p_band_height, p_hardness,
			...
			p_profile_mode, p_hardness_variation);
}
...
void Pasture3DUtil::_bind_methods() {
	...
	ClassDB::bind_static_method("Pasture3DUtil",
			D_METHOD("strata_grid", "surface", "gw", "gh", "rect", "band_height", "hardness", "amount", "dip", "dip_direction_deg", "break_amount", "break_size", "seed", "profile_lut", "profile_mode", "hardness_variation"),
			&Pasture3DUtil::strata_grid, DEFVAL(PackedFloat32Array()), DEFVAL(0), DEFVAL(0.0));
	ClassDB::bind_static_method("Pasture3DUtil",
