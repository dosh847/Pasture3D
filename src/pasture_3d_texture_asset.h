...
#ifndef PASTURE3D_TEXTURE_CLASS_H
#define PASTURE3D_TEXTURE_CLASS_H
...
class Pasture3DTextureAsset : public Pasture3DAssetResource {
	GDCLASS(Pasture3DTextureAsset, Pasture3DAssetResource);
	CLASS_NAME();
	friend class Pasture3DAssets;
...
public:
	Pasture3DTextureAsset() { clear(); }
	~Pasture3DTextureAsset() {}
...
#endif // PASTURE3D_TEXTURE_CLASS_H
