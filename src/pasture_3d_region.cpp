...
void Pasture3DRegion::set_version(const real_t p_version) {
	...
	if (_version < Pasture3DData::CURRENT_DATA_VERSION) {
		LOG(WARN, "Region Data ", get_path(), " version ", vformat("%.3f", _version),
				" will be updated to ", vformat("%.3f", Pasture3DData::CURRENT_DATA_VERSION), " upon save");
	}
}

void Pasture3DRegion::set_region_size(const int p_region_size) {
...
Ref<Image> Pasture3DRegion::get_map(const MapType p_map_type) const {
	switch (p_map_type) {
		case TYPE_HEIGHT:
...
Image *Pasture3DRegion::get_map_ptr(const MapType p_map_type) const {
	switch (p_map_type) {
		case TYPE_HEIGHT:
			return *_height_map;
		case TYPE_CONTROL:
...
void Pasture3DRegion::set_maps(const TypedArray<Image> &p_maps) {
...
TypedArray<Image> Pasture3DRegion::get_maps() const {
...
void Pasture3DRegion::set_height_map(const Ref<Image> &p_map) {
...
void Pasture3DRegion::set_control_map(const Ref<Image> &p_map) {
...
void Pasture3DRegion::set_color_map(const Ref<Image> &p_map) {
...
void Pasture3DRegion::sanitize_maps() {
...
Ref<Image> Pasture3DRegion::sanitize_map(const MapType p_map_type, const Ref<Image> &p_map) const {
...
bool Pasture3DRegion::validate_map_size(const Ref<Image> &p_map) const {
...
void Pasture3DRegion::set_height_range(const Vector2 &p_range) {
...
void Pasture3DRegion::calc_height_range() {
...
void Pasture3DRegion::set_instances(const Dictionary &p_instances) {
...
void Pasture3DRegion::set_location(const Vector2i &p_location) {
...
Error Pasture3DRegion::save(const String &p_path, const bool p_16_bit) {
	...
	set_version(Pasture3DData::CURRENT_DATA_VERSION);
	Error err = OK;
	if (p_16_bit) {
...
void Pasture3DRegion::set_data(const Dictionary &p_data) {
...
Dictionary Pasture3DRegion::get_data() const {
	Dictionary dict;
...
Ref<Pasture3DRegion> Pasture3DRegion::duplicate(const bool p_deep) {
...
void Pasture3DRegion::_bind_methods() {
	BIND_ENUM_CONSTANT(TYPE_HEIGHT);
	BIND_ENUM_CONSTANT(TYPE_CONTROL);
	BIND_ENUM_CONSTANT(TYPE_COLOR);
	BIND_ENUM_CONSTANT(TYPE_MAX);

	ClassDB::bind_method(D_METHOD("clear"), &Pasture3DRegion::clear);
	ClassDB::bind_method(D_METHOD("set_version", "version"), &Pasture3DRegion::set_version);
	...
	ClassDB::bind_method(D_METHOD("set_map", "map_type", "map"), &Pasture3DRegion::set_map);
	ClassDB::bind_method(D_METHOD("get_map", "map_type"), &Pasture3DRegion::get_map);
	ClassDB::bind_method(D_METHOD("set_maps", "maps"), &Pasture3DRegion::set_maps);
	ClassDB::bind_method(D_METHOD("get_maps"), &Pasture3DRegion::get_maps);
	ClassDB::bind_method(D_METHOD("set_height_map", "map"), &Pasture3DRegion::set_height_map);
	ClassDB::bind_method(D_METHOD("get_height_map"), &Pasture3DRegion::get_height_map);
	ClassDB::bind_method(D_METHOD("set_control_map", "map"), &Pasture3DRegion::set_control_map);
	ClassDB::bind_method(D_METHOD("get_control_map"), &Pasture3DRegion::get_control_map);
	ClassDB::bind_method(D_METHOD("set_color_map", "map"), &Pasture3DRegion::set_color_map);
	ClassDB::bind_method(D_METHOD("get_color_map"), &Pasture3DRegion::get_color_map);
	ClassDB::bind_method(D_METHOD("sanitize_maps"), &Pasture3DRegion::sanitize_maps);
	ClassDB::bind_method(D_METHOD("sanitize_map", "map_type", "map"), &Pasture3DRegion::sanitize_map);
	ClassDB::bind_method(D_METHOD("validate_map_size", "map"), &Pasture3DRegion::validate_map_size);

	ClassDB::bind_method(D_METHOD("set_height_range", "range"), &Pasture3DRegion::set_height_range);
	ClassDB::bind_method(D_METHOD("get_height_range"), &Pasture3DRegion::get_height_range);
	ClassDB::bind_method(D_METHOD("update_height", "height"), &Pasture3DRegion::update_height);
	ClassDB::bind_method(D_METHOD("update_heights", "low_high"), &Pasture3DRegion::update_heights);
	ClassDB::bind_method(D_METHOD("calc_height_range"), &Pasture3DRegion::calc_height_range);

	ClassDB::bind_method(D_METHOD("set_instances", "instances"), &Pasture3DRegion::set_instances);
	ClassDB::bind_method(D_METHOD("get_instances"), &Pasture3DRegion::get_instances);

	ClassDB::bind_method(D_METHOD("save", "path", "save_16_bit"), &Pasture3DRegion::save, DEFVAL(""), DEFVAL(false));

	ClassDB::bind_method(D_METHOD("set_deleted", "deleted"), &Pasture3DRegion::set_deleted);
	ClassDB::bind_method(D_METHOD("is_deleted"), &Pasture3DRegion::is_deleted);
	ClassDB::bind_method(D_METHOD("set_edited", "edited"), &Pasture3DRegion::set_edited);
	ClassDB::bind_method(D_METHOD("is_edited"), &Pasture3DRegion::is_edited);
	ClassDB::bind_method(D_METHOD("set_modified", "modified"), &Pasture3DRegion::set_modified);
	ClassDB::bind_method(D_METHOD("is_modified"), &Pasture3DRegion::is_modified);
	ClassDB::bind_method(D_METHOD("set_location", "location"), &Pasture3DRegion::set_location);
	ClassDB::bind_method(D_METHOD("get_location"), &Pasture3DRegion::get_location);

	ClassDB::bind_method(D_METHOD("set_data", "data"), &Pasture3DRegion::set_data);
	ClassDB::bind_method(D_METHOD("get_data"), &Pasture3DRegion::get_data);
	ClassDB::bind_method(D_METHOD("duplicate", "deep"), &Pasture3DRegion::duplicate, DEFVAL(false));
	ClassDB::bind_method(D_METHOD("dump", "verbose"), &Pasture3DRegion::dump, DEFVAL(false));
