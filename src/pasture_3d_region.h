...
#ifndef PASTURE3D_REGION_CLASS_H
#define PASTURE3D_REGION_CLASS_H
...
class Pasture3DRegion : public Resource {
	GDCLASS(Pasture3DRegion, Resource);
	CLASS_NAME();
...
public:
	...
	Ref<Pasture3DRegion> duplicate(const bool p_deep = false);
...
using MapType = Pasture3DRegion::MapType;
VARIANT_ENUM_CAST(Pasture3DRegion::MapType);
constexpr Pasture3DRegion::MapType TYPE_HEIGHT = Pasture3DRegion::MapType::TYPE_HEIGHT;
constexpr Pasture3DRegion::MapType TYPE_CONTROL = Pasture3DRegion::MapType::TYPE_CONTROL;
constexpr Pasture3DRegion::MapType TYPE_COLOR = Pasture3DRegion::MapType::TYPE_COLOR;
constexpr Pasture3DRegion::MapType TYPE_MAX = Pasture3DRegion::MapType::TYPE_MAX;
constexpr inline const Image::Format *FORMAT = Pasture3DRegion::FORMAT;
constexpr inline const char **TYPESTR = Pasture3DRegion::TYPESTR;
constexpr inline const Color *COLOR = Pasture3DRegion::COLOR;

// Inline functions

inline void Pasture3DRegion::update_height(const real_t p_height) {
...
inline void Pasture3DRegion::update_heights(const Vector2 &p_low_high) {
...
#endif // PASTURE3D_REGION_CLASS_H
