...
void Pasture3DMeshAsset::_clear_lod_ranges() {
	...
	for (int i = 0; i < MAX_LOD_COUNT; i++) {
		_lod_ranges[i] = (i + 1) * Pasture3DInstancer::CELL_SIZE;
	}
	_lod_ranges[_last_lod] = MAX(_lod_ranges[_last_lod], 128.f);
}

bool Pasture3DMeshAsset::_sort_lod_nodes(const Node *a, const Node *b) {
	ASSERT(a && b, false);
	return a->get_name().right(1) < b->get_name().right(1);
}

Ref<ArrayMesh> Pasture3DMeshAsset::_create_generated_mesh(const GenType p_type) const {
...
void Pasture3DMeshAsset::_assign_generated_mesh() {
...
Ref<Material> Pasture3DMeshAsset::_get_material() {
	if (_material_override.is_null()) {
		...
		mat->set_meta("pasture3d_generated_material", true);
		return mat;
	} else {
...
// Called by Pasture3DAssets::_set_asset_list() and _set_asset()
void Pasture3DMeshAsset::initialize() {
...
void Pasture3DMeshAsset::set_name(const String &p_name) {
	if (p_name.length() > 96) {
...
void Pasture3DMeshAsset::set_id(const int p_new_id) {
	int old_id = _id;
	SET_IF_DIFF(_id, CLAMP(p_new_id, 0, Pasture3DAssets::MAX_MESHES - 1));
	LOG(INFO, _name, ": Setting mesh ID: ", _id);
	LOG(DEBUG, "Emitting id_changed, TYPE_MESH, ", old_id, ", ", p_new_id);
	emit_signal("id_changed", Pasture3DAssets::TYPE_MESH, old_id, p_new_id);
}

void Pasture3DMeshAsset::set_highlighted(const bool p_highlighted) {
...
Color Pasture3DMeshAsset::get_highlight_color() const {
...
void Pasture3DMeshAsset::set_enabled(const bool p_enabled) {
...
void Pasture3DMeshAsset::update_instance_count(const int p_amount) {
	if (p_amount == 0) {
		return;
	}
...
void Pasture3DMeshAsset::set_instance_count(const uint32_t p_amount) {
...
void Pasture3DMeshAsset::set_scene_file(const Ref<PackedScene> &p_scene_file) {
	...
	if (_packed_scene.is_valid()) {
		...
		_height_offset = 0.0f;
		_generated_type = TYPE_NONE;
		if (_material_override.is_valid() && _material_override->has_meta("pasture3d_generated_material")) {
			_material_override.unref();
		}
		...
		if (mesh_instances.size() > 0) {
			...
			mesh_instances.sort_custom(callable_mp_static(&Pasture3DMeshAsset::_sort_lod_nodes));
		}
		...
		for (int i = 0, count = MIN(mesh_instances.size(), MAX_LOD_COUNT); i < count; i++) {
			...
			// Duplicate the mesh to make each Pasture3DMeshAsset unique
			mesh = mesh->duplicate();
...
void Pasture3DMeshAsset::commit_meshes() {
...
void Pasture3DMeshAsset::set_generated_type(const GenType p_type) {
...
Ref<Mesh> Pasture3DMeshAsset::get_mesh(const int p_lod) const {
...
void Pasture3DMeshAsset::set_height_offset(const real_t p_offset) {
...
void Pasture3DMeshAsset::set_density(const real_t p_density) {
...
void Pasture3DMeshAsset::set_cast_shadows(const ShadowCasting p_cast_shadows) {
...
ShadowCasting Pasture3DMeshAsset::get_lod_cast_shadows(const int p_lod_id) const {
...
inline void Pasture3DMeshAsset::set_visibility_layers(const uint32_t p_layers) {
...
void Pasture3DMeshAsset::set_material_override(const Ref<Material> &p_material) {
...
void Pasture3DMeshAsset::set_material_overlay(const Ref<Material> &p_material) {
...
void Pasture3DMeshAsset::set_generated_faces(const int p_count) {
...
void Pasture3DMeshAsset::set_generated_size(const Vector2 &p_size) {
...
void Pasture3DMeshAsset::set_last_lod(const int p_lod) {
...
void Pasture3DMeshAsset::set_last_shadow_lod(const int p_lod) {
...
void Pasture3DMeshAsset::set_shadow_impostor(const int p_lod) {
...
void Pasture3DMeshAsset::set_lod_range(const int p_lod, const real_t p_distance) {
...
real_t Pasture3DMeshAsset::get_lod_range(const int p_lod) const {
	if (p_lod < 0 || p_lod >= _lod_ranges.size()) {
		return -1.f;
	}
...
real_t Pasture3DMeshAsset::get_lod_range_begin(const int p_lod) const {
	if (p_lod <= 0) {
		return 0.f;
	}
...
real_t Pasture3DMeshAsset::get_lod_range_end(const int p_lod) const {
...
void Pasture3DMeshAsset::set_fade_margin(const real_t p_fade_margin) {
...
void Pasture3DMeshAsset::_validate_property(PropertyInfo &p_property) const {
...
bool Pasture3DMeshAsset::_property_can_revert(const StringName &p_name) const {
	return (
...
bool Pasture3DMeshAsset::_property_get_revert(const StringName &p_name, Variant &r_property) const {
...
void Pasture3DMeshAsset::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("clear"), &Pasture3DMeshAsset::clear);
	ClassDB::bind_method(D_METHOD("set_name", "name"), &Pasture3DMeshAsset::set_name);
	ClassDB::bind_method(D_METHOD("get_name"), &Pasture3DMeshAsset::get_name);
	ClassDB::bind_method(D_METHOD("set_id", "id"), &Pasture3DMeshAsset::set_id);
	ClassDB::bind_method(D_METHOD("get_id"), &Pasture3DMeshAsset::get_id);
	ClassDB::bind_method(D_METHOD("set_highlighted", "enabled"), &Pasture3DMeshAsset::set_highlighted);
	ClassDB::bind_method(D_METHOD("is_highlighted"), &Pasture3DMeshAsset::is_highlighted);
	ClassDB::bind_method(D_METHOD("get_highlight_color"), &Pasture3DMeshAsset::get_highlight_color);
	ClassDB::bind_method(D_METHOD("get_thumbnail"), &Pasture3DMeshAsset::get_thumbnail);

	ClassDB::bind_method(D_METHOD("set_enabled", "enabled"), &Pasture3DMeshAsset::set_enabled);
	ClassDB::bind_method(D_METHOD("is_enabled"), &Pasture3DMeshAsset::is_enabled);

	ClassDB::bind_method(D_METHOD("set_scene_file", "scene_file"), &Pasture3DMeshAsset::set_scene_file);
	ClassDB::bind_method(D_METHOD("get_scene_file"), &Pasture3DMeshAsset::get_scene_file);
	ClassDB::bind_method(D_METHOD("set_generated_type", "type"), &Pasture3DMeshAsset::set_generated_type);
	ClassDB::bind_method(D_METHOD("get_generated_type"), &Pasture3DMeshAsset::get_generated_type);
	ClassDB::bind_method(D_METHOD("get_mesh", "lod"), &Pasture3DMeshAsset::get_mesh, DEFVAL(0));
	ClassDB::bind_method(D_METHOD("set_height_offset", "offset"), &Pasture3DMeshAsset::set_height_offset);
	ClassDB::bind_method(D_METHOD("get_height_offset"), &Pasture3DMeshAsset::get_height_offset);
	ClassDB::bind_method(D_METHOD("set_density", "density"), &Pasture3DMeshAsset::set_density);
	ClassDB::bind_method(D_METHOD("get_density"), &Pasture3DMeshAsset::get_density);
	ClassDB::bind_method(D_METHOD("set_cast_shadows", "mode"), &Pasture3DMeshAsset::set_cast_shadows);
	ClassDB::bind_method(D_METHOD("get_cast_shadows"), &Pasture3DMeshAsset::get_cast_shadows);
	ClassDB::bind_method(D_METHOD("set_visibility_layers", "layers"), &Pasture3DMeshAsset::set_visibility_layers);
	ClassDB::bind_method(D_METHOD("get_visibility_layers"), &Pasture3DMeshAsset::get_visibility_layers);
	ClassDB::bind_method(D_METHOD("set_material_override", "material"), &Pasture3DMeshAsset::set_material_override);
	ClassDB::bind_method(D_METHOD("get_material_override"), &Pasture3DMeshAsset::get_material_override);
	ClassDB::bind_method(D_METHOD("set_material_overlay", "material"), &Pasture3DMeshAsset::set_material_overlay);
	ClassDB::bind_method(D_METHOD("get_material_overlay"), &Pasture3DMeshAsset::get_material_overlay);

	ClassDB::bind_method(D_METHOD("set_generated_faces", "count"), &Pasture3DMeshAsset::set_generated_faces);
	ClassDB::bind_method(D_METHOD("get_generated_faces"), &Pasture3DMeshAsset::get_generated_faces);
	ClassDB::bind_method(D_METHOD("set_generated_size", "size"), &Pasture3DMeshAsset::set_generated_size);
	ClassDB::bind_method(D_METHOD("get_generated_size"), &Pasture3DMeshAsset::get_generated_size);

	ClassDB::bind_method(D_METHOD("get_lod_count"), &Pasture3DMeshAsset::get_lod_count);
	ClassDB::bind_method(D_METHOD("set_last_lod", "lod"), &Pasture3DMeshAsset::set_last_lod);
	ClassDB::bind_method(D_METHOD("get_last_lod"), &Pasture3DMeshAsset::get_last_lod);
	ClassDB::bind_method(D_METHOD("set_last_shadow_lod", "lod"), &Pasture3DMeshAsset::set_last_shadow_lod);
	ClassDB::bind_method(D_METHOD("get_last_shadow_lod"), &Pasture3DMeshAsset::get_last_shadow_lod);
	ClassDB::bind_method(D_METHOD("set_shadow_impostor", "lod"), &Pasture3DMeshAsset::set_shadow_impostor);
	ClassDB::bind_method(D_METHOD("get_shadow_impostor"), &Pasture3DMeshAsset::get_shadow_impostor);

	ClassDB::bind_method(D_METHOD("set_lod_range", "lod", "distance"), &Pasture3DMeshAsset::set_lod_range);
	ClassDB::bind_method(D_METHOD("get_lod_range", "lod"), &Pasture3DMeshAsset::get_lod_range);
	ClassDB::bind_method(D_METHOD("set_lod0_range", "distance"), &Pasture3DMeshAsset::set_lod0_range);
	ClassDB::bind_method(D_METHOD("get_lod0_range"), &Pasture3DMeshAsset::get_lod0_range);
	ClassDB::bind_method(D_METHOD("set_lod1_range", "distance"), &Pasture3DMeshAsset::set_lod1_range);
	ClassDB::bind_method(D_METHOD("get_lod1_range"), &Pasture3DMeshAsset::get_lod1_range);
	ClassDB::bind_method(D_METHOD("set_lod2_range", "distance"), &Pasture3DMeshAsset::set_lod2_range);
	ClassDB::bind_method(D_METHOD("get_lod2_range"), &Pasture3DMeshAsset::get_lod2_range);
	ClassDB::bind_method(D_METHOD("set_lod3_range", "distance"), &Pasture3DMeshAsset::set_lod3_range);
	ClassDB::bind_method(D_METHOD("get_lod3_range"), &Pasture3DMeshAsset::get_lod3_range);
	ClassDB::bind_method(D_METHOD("set_lod4_range", "distance"), &Pasture3DMeshAsset::set_lod4_range);
	ClassDB::bind_method(D_METHOD("get_lod4_range"), &Pasture3DMeshAsset::get_lod4_range);
	ClassDB::bind_method(D_METHOD("set_lod5_range", "distance"), &Pasture3DMeshAsset::set_lod5_range);
	ClassDB::bind_method(D_METHOD("get_lod5_range"), &Pasture3DMeshAsset::get_lod5_range);
	ClassDB::bind_method(D_METHOD("set_lod6_range", "distance"), &Pasture3DMeshAsset::set_lod6_range);
	ClassDB::bind_method(D_METHOD("get_lod6_range"), &Pasture3DMeshAsset::get_lod6_range);
	ClassDB::bind_method(D_METHOD("set_lod7_range", "distance"), &Pasture3DMeshAsset::set_lod7_range);
	ClassDB::bind_method(D_METHOD("get_lod7_range"), &Pasture3DMeshAsset::get_lod7_range);
	ClassDB::bind_method(D_METHOD("set_lod8_range", "distance"), &Pasture3DMeshAsset::set_lod8_range);
	ClassDB::bind_method(D_METHOD("get_lod8_range"), &Pasture3DMeshAsset::get_lod8_range);
	ClassDB::bind_method(D_METHOD("set_lod9_range", "distance"), &Pasture3DMeshAsset::set_lod9_range);
	ClassDB::bind_method(D_METHOD("get_lod9_range"), &Pasture3DMeshAsset::get_lod9_range);
	ClassDB::bind_method(D_METHOD("set_fade_margin", "distance"), &Pasture3DMeshAsset::set_fade_margin);
	ClassDB::bind_method(D_METHOD("get_fade_margin"), &Pasture3DMeshAsset::get_fade_margin);

	ClassDB::bind_method(D_METHOD("get_instance_count"), &Pasture3DMeshAsset::get_instance_count);
