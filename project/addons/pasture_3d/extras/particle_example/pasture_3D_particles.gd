...
#
# This is an example of using a particle shader with Pasture3D.
# To use it, add `Pasture3DParticles.tscn` to your scene and connect terrain to your Pasture3D node.
...
## Auto set if attached as a child of a Pasture3D node
