...
# Channel Packer for Pasture3D
extends RefCounted

const WINDOW_SCENE: String = "res://addons/pasture_3d/menu/channel_packer.tscn"
const TEMPLATE_PATH: String = "res://addons/pasture_3d/menu/channel_packer_import_template.txt"
const DRAG_DROP_SCRIPT: String = "res://addons/pasture_3d/menu/channel_packer_dragdrop.gd"
enum { 
	INFO,
	WARN,
	ERROR,
	...
	if p_image_index == IMAGE_HEIGHT:
		var lumin_fn: Callable = func() -> void:
			if !images[IMAGE_ALBEDO]:
				...
				var height_texture: Image = Pasture3DUtil.luminance_to_height(images[IMAGE_ALBEDO])
...
func _pack_textures(p_rgb_image: Image, p_a_image: Image, p_ao_image: Image, p_dst_path: String, p_invert_green: bool,
	...
	if p_rgb_image and p_a_image:
		...
		var output_image: Image = Pasture3DUtil.pack_image(p_rgb_image, p_a_image, p_ao_image,
