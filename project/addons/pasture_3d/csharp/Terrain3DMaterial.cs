...
[Tool]
public partial class Pasture3DMaterial : Resource
{

	private new static readonly StringName NativeName = new StringName("Pasture3DMaterial");

	[Obsolete("Wrapper types cannot be constructed with constructors (it only instantiate the underlying Pasture3DMaterial object), please use the Instantiate() method instead.")]
	protected Pasture3DMaterial() { }

	private static CSharpScript _wrapperScriptAsset;

	/// <summary>
	/// Try to cast the script on the supplied <paramref name="godotObject"/> to the <see cref="Pasture3DMaterial"/> wrapper type,
	/// if no script has attached to the type, or the script attached to the type does not inherit the <see cref="Pasture3DMaterial"/> wrapper type,
	/// a new instance of the <see cref="Pasture3DMaterial"/> wrapper script will get attaches to the <paramref name="godotObject"/>.
	/// </summary>
	/// <remarks>The developer should only supply the <paramref name="godotObject"/> that represents the correct underlying GDExtension type.</remarks>
	/// <param name="godotObject">The <paramref name="godotObject"/> that represents the correct underlying GDExtension type.</param>
	/// <returns>The existing or a new instance of the <see cref="Pasture3DMaterial"/> wrapper script attached to the supplied <paramref name="godotObject"/>.</returns>
	public new static Pasture3DMaterial Bind(GodotObject godotObject)
	{
		if (!IsInstanceValid(godotObject))
			return null;

		if (godotObject is Pasture3DMaterial wrapperScriptInstance)
			return wrapperScriptInstance;

#if DEBUG
		var expectedType = typeof(Pasture3DMaterial);
		...
		{
			var scriptPathAttribute = typeof(Pasture3DMaterial).GetCustomAttributes<ScriptPathAttribute>().FirstOrDefault();
		...
		return (Pasture3DMaterial)InstanceFromId(instanceId);
	}

	/// <summary>
	/// Creates an instance of the GDExtension <see cref="Pasture3DMaterial"/> type, and attaches a wrapper script instance to it.
	/// </summary>
	/// <returns>The wrapper instance linked to the underlying GDExtension "Pasture3DMaterial" type.</returns>
	public new static Pasture3DMaterial Instantiate() => Bind(ClassDB.Instantiate(NativeName).As<GodotObject>());
	...
	public new Pasture3DMaterial.WorldBackgroundEnum WorldBackground
	{
		get => Get(GDExtensionPropertyName.WorldBackground).As<Pasture3DMaterial.WorldBackgroundEnum>();
		set => Set(GDExtensionPropertyName.WorldBackground, Variant.From(value));
	}

	public new Pasture3DMaterial.TextureFilteringEnum TextureFiltering
	{
		get => Get(GDExtensionPropertyName.TextureFiltering).As<Pasture3DMaterial.TextureFilteringEnum>();
...
{
public static int SafeAsInt32(this Pasture3DMaterial.WorldBackgroundEnum enumValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3DMaterial.WorldBackgroundEnum enumValue, int defaultValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3DMaterial.WorldBackgroundEnum? enumValue, int defaultValue = 0) =>
enumValue.HasValue ? Convert.ToInt32(enumValue.Value) : defaultValue;
}

file static class TextureFilteringEnumExtensions
{
public static int SafeAsInt32(this Pasture3DMaterial.TextureFilteringEnum enumValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3DMaterial.TextureFilteringEnum enumValue, int defaultValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3DMaterial.TextureFilteringEnum? enumValue, int defaultValue = 0) =>
enumValue.HasValue ? Convert.ToInt32(enumValue.Value) : defaultValue;
}

file static class UpdateFlagsExtensions
{
public static int SafeAsInt32(this Pasture3DMaterial.UpdateFlags enumValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3DMaterial.UpdateFlags enumValue, int defaultValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3DMaterial.UpdateFlags? enumValue, int defaultValue = 0) =>
enumValue.HasValue ? Convert.ToInt32(enumValue.Value) : defaultValue;
}
