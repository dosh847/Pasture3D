...
[Tool]
public partial class Pasture3DInstancer : GodotObject
{

	private new static readonly StringName NativeName = new StringName("Pasture3DInstancer");

	[Obsolete("Wrapper types cannot be constructed with constructors (it only instantiate the underlying Pasture3DInstancer object), please use the Instantiate() method instead.")]
	protected Pasture3DInstancer() { }

	private static CSharpScript _wrapperScriptAsset;

	/// <summary>
	/// Try to cast the script on the supplied <paramref name="godotObject"/> to the <see cref="Pasture3DInstancer"/> wrapper type,
	/// if no script has attached to the type, or the script attached to the type does not inherit the <see cref="Pasture3DInstancer"/> wrapper type,
	/// a new instance of the <see cref="Pasture3DInstancer"/> wrapper script will get attaches to the <paramref name="godotObject"/>.
	/// </summary>
	/// <remarks>The developer should only supply the <paramref name="godotObject"/> that represents the correct underlying GDExtension type.</remarks>
	/// <param name="godotObject">The <paramref name="godotObject"/> that represents the correct underlying GDExtension type.</param>
	/// <returns>The existing or a new instance of the <see cref="Pasture3DInstancer"/> wrapper script attached to the supplied <paramref name="godotObject"/>.</returns>
	public new static Pasture3DInstancer Bind(GodotObject godotObject)
	{
		if (!IsInstanceValid(godotObject))
			return null;

		if (godotObject is Pasture3DInstancer wrapperScriptInstance)
			return wrapperScriptInstance;

#if DEBUG
		var expectedType = typeof(Pasture3DInstancer);
		...
		{
			var scriptPathAttribute = typeof(Pasture3DInstancer).GetCustomAttributes<ScriptPathAttribute>().FirstOrDefault();
		...
		return (Pasture3DInstancer)InstanceFromId(instanceId);
	}

	/// <summary>
	/// Creates an instance of the GDExtension <see cref="Pasture3DInstancer"/> type, and attaches a wrapper script instance to it.
	/// </summary>
	/// <returns>The wrapper instance linked to the underlying GDExtension "Pasture3DInstancer" type.</returns>
	public new static Pasture3DInstancer Instantiate() => Bind(ClassDB.Instantiate(NativeName).As<GodotObject>());
	...
	public new Pasture3DInstancer.InstancerMode Mode
	{
		get => Get(GDExtensionPropertyName.Mode).As<Pasture3DInstancer.InstancerMode>();
	...
	public new void ClearByRegion(Pasture3DRegion region, long meshId) => 
	...
	public new void AppendRegion(Pasture3DRegion region, long meshId, Godot.Collections.Array transforms, Color[] colors, bool update = true) => 
...
{
public static int SafeAsInt32(this Pasture3DInstancer.InstancerMode enumValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3DInstancer.InstancerMode enumValue, int defaultValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3DInstancer.InstancerMode? enumValue, int defaultValue = 0) =>
