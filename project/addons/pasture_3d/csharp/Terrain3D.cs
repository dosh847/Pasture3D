...
[Tool]
public partial class Pasture3D : Node3D
{

	private new static readonly StringName NativeName = new StringName("Pasture3D");

	[Obsolete("Wrapper types cannot be constructed with constructors (it only instantiate the underlying Pasture3D object), please use the Instantiate() method instead.")]
	protected Pasture3D() { }

	private static CSharpScript _wrapperScriptAsset;

	/// <summary>
	/// Try to cast the script on the supplied <paramref name="godotObject"/> to the <see cref="Pasture3D"/> wrapper type,
	/// if no script has attached to the type, or the script attached to the type does not inherit the <see cref="Pasture3D"/> wrapper type,
	/// a new instance of the <see cref="Pasture3D"/> wrapper script will get attaches to the <paramref name="godotObject"/>.
	/// </summary>
	/// <remarks>The developer should only supply the <paramref name="godotObject"/> that represents the correct underlying GDExtension type.</remarks>
	/// <param name="godotObject">The <paramref name="godotObject"/> that represents the correct underlying GDExtension type.</param>
	/// <returns>The existing or a new instance of the <see cref="Pasture3D"/> wrapper script attached to the supplied <paramref name="godotObject"/>.</returns>
	public new static Pasture3D Bind(GodotObject godotObject)
	{
		if (!IsInstanceValid(godotObject))
			return null;

		if (godotObject is Pasture3D wrapperScriptInstance)
			return wrapperScriptInstance;

#if DEBUG
		var expectedType = typeof(Pasture3D);
		...
		{
			var scriptPathAttribute = typeof(Pasture3D).GetCustomAttributes<ScriptPathAttribute>().FirstOrDefault();
		...
		return (Pasture3D)InstanceFromId(instanceId);
	}

	/// <summary>
	/// Creates an instance of the GDExtension <see cref="Pasture3D"/> type, and attaches a wrapper script instance to it.
	/// </summary>
	/// <returns>The wrapper instance linked to the underlying GDExtension "Pasture3D" type.</returns>
	public new static Pasture3D Instantiate() => Bind(ClassDB.Instantiate(NativeName).As<GodotObject>());
	...
	public new Pasture3D.DebugLevelEnum DebugLevel
	{
		get => Get(GDExtensionPropertyName.DebugLevel).As<Pasture3D.DebugLevelEnum>();
	...
	public new Pasture3DMaterial Material
	{
		get => Pasture3DMaterial.Bind(Get(GDExtensionPropertyName.Material).As<Resource>());
		set => Set(GDExtensionPropertyName.Material, value);
	}

	public new Pasture3DAssets Assets
	{
		get => Pasture3DAssets.Bind(Get(GDExtensionPropertyName.Assets).As<Resource>());
		set => Set(GDExtensionPropertyName.Assets, value);
	}

	public new Pasture3DData Data
	{
		get => Pasture3DData.Bind(Get(GDExtensionPropertyName.Data).As<GodotObject>());
	}

	public new Pasture3DCollision Collision
	{
		get => Pasture3DCollision.Bind(Get(GDExtensionPropertyName.Collision).As<GodotObject>());
	}

	public new Pasture3DInstancer Instancer
	{
		get => Pasture3DInstancer.Bind(Get(GDExtensionPropertyName.Instancer).As<GodotObject>());
	}

	public new Pasture3D.RegionSizeEnum RegionSize
	{
		get => Get(GDExtensionPropertyName.RegionSize).As<Pasture3D.RegionSizeEnum>();
	...
	public new Pasture3DCollision.CollisionMode CollisionMode
	{
		get => Get(GDExtensionPropertyName.CollisionMode).As<Pasture3DCollision.CollisionMode>();
	...
	public new Pasture3DInstancer.InstancerMode InstancerMode
	{
		get => Get(GDExtensionPropertyName.InstancerMode).As<Pasture3DInstancer.InstancerMode>();
	...
	public new void SetEditor(Pasture3DEditor editor) => 
		Call(GDExtensionMethodName.SetEditor, [editor]);

	public new Pasture3DEditor GetEditor() => 
		Pasture3DEditor.Bind(Call(GDExtensionMethodName.GetEditor, []).As<GodotObject>());
	...
	public new Mesh BakeMesh(long lod, Pasture3DData.HeightFilter filter = Pasture3DData.HeightFilter.Nearest) => 
...
{
public static int SafeAsInt32(this Pasture3D.DebugLevelEnum enumValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3D.DebugLevelEnum enumValue, int defaultValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3D.DebugLevelEnum? enumValue, int defaultValue = 0) =>
enumValue.HasValue ? Convert.ToInt32(enumValue.Value) : defaultValue;
}

file static class RegionSizeEnumExtensions
{
public static int SafeAsInt32(this Pasture3D.RegionSizeEnum enumValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3D.RegionSizeEnum enumValue, int defaultValue) =>
Convert.ToInt32(enumValue);

public static int SafeAsInt32(this Pasture3D.RegionSizeEnum? enumValue, int defaultValue = 0) =>
enumValue.HasValue ? Convert.ToInt32(enumValue.Value) : defaultValue;
}
