...
# Gradient Operation Builder for Pasture3D
extends "res://addons/pasture_3d/src/operation_builder.gd"
...
func apply_operation(p_editor: Pasture3DEditor, p_global_position: Vector3, p_camera_direction: float) -> void:
