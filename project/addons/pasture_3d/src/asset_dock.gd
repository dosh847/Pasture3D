...
#class EdDock extends EditorDock:
	#func _update_layout(layout: int) -> void:
		...
		#print("Pasture3DAssetDock: _update_layout called with: ", layout)
...
func initialize(p_plugin: EditorPlugin) -> void:
	...
	_dock.title = "Pasture3D"
	_dock.dock_icon = preload("../icons/pasture3d.svg")
...
func load_editor_settings() -> void:
	...
	const ES_DOCK: String = "pasture3d/dock/"
